...
> \chatapi\chatapi\SetWebhookStatus setWebhook($webhook_url)
...
$apiInstance = new chatapi\Api\Class4WebhooksApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$webhook_url = new \chatapi\chatapi\WebhookUrl(); // \chatapi\chatapi\WebhookUrl | 
...
------------- | ------------- | ------------- | -------------
 **webhook_url** | [**\chatapi\chatapi\WebhookUrl**](../Model/WebhookUrl.md)|  |

### Return type

[**\chatapi\chatapi\SetWebhookStatus**](../Model/SetWebhookStatus.md)
