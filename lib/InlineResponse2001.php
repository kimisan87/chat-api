...
class InlineResponse2001 implements ModelInterface, ArrayAccess
{
    ...
    const ACCOUNT_STATUS_SENT_TO_WHATS_APP = 'Takeover request sent to WhatsApp';
    const ACCOUNT_STATUS_NOT_SENT_BECAUSE_REASON_DONT_EQUALS_CONFLICT = 'Takeover request not sent because reason don\'t equals \"conflict\"';
    ...
    public function getAccountStatusAllowableValues()
    {
        return [
            ...
            self::ACCOUNT_STATUS_NOT_SENT_BECAUSE_REASON_DONT_EQUALS_CONFLICT,
        ];
    }
