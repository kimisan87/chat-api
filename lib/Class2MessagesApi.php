...
class Class2MessagesApi
{
     ...
     *
     * @param  \chatapi\chatapi\ForwardMessageRequest $forward_message_request forward_message_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\SendMessageStatus
     */
     ...
     * Forwarding messages to a new or existing chat.
     *
     * @param  \chatapi\chatapi\ForwardMessageRequest $forward_message_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function forwardMessageWithHttpInfo($forward_message_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\chatapi\chatapi\SendMessageStatus' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\chatapi\chatapi\SendMessageStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\chatapi\chatapi\SendMessageStatus';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\chatapi\chatapi\SendMessageStatus',
     ...
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\Messages
     */
     ...
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\Messages, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMessagesWithHttpInfo($last_message_number = null, $last = false, $chat_id = null, $limit = null, $min_time = null, $max_time = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\chatapi\chatapi\Messages' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\chatapi\chatapi\Messages', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\chatapi\chatapi\Messages';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     *
     * @param  \chatapi\chatapi\SendContactRequest $send_contact_request send_contact_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\SendMessageStatus
     ...
     * Sending a contact or contact list to a new or existing chat.
     *
     * @param  \chatapi\chatapi\SendContactRequest $send_contact_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \chatapi\chatapi\SendFileRequest $send_file_request send_file_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\SendMessageStatus
     ...
     * Send a file to a new or existing chat.
     *
     * @param  \chatapi\chatapi\SendFileRequest $send_file_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \chatapi\chatapi\SendLinkRequest $send_link_request send_link_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\SendMessageStatus
     ...
     * Send text with link and link's preview to a new or existing chat.
     *
     * @param  \chatapi\chatapi\SendLinkRequest $send_link_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \chatapi\chatapi\SendLocationRequest $send_location_request send_location_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\SendMessageStatus
     ...
     * Sending a location to a new or existing chat.
     *
     * @param  \chatapi\chatapi\SendLocationRequest $send_location_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \chatapi\chatapi\SendMessageRequest $send_message_request send_message_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\SendMessageStatus
     ...
     * Send a message to a new or existing chat.
     *
     * @param  \chatapi\chatapi\SendMessageRequest $send_message_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \chatapi\chatapi\SendPTTRequest $send_ptt_request send_ptt_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\SendMessageStatus
     ...
     * Send a ptt-audio to a new or existing chat.
     *
     * @param  \chatapi\chatapi\SendPTTRequest $send_ptt_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \chatapi\chatapi\SendVCardRequest $send_v_card_request send_v_card_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\SendMessageStatus
     ...
     * Sending a vcard to a new or existing chat.
     *
     * @param  \chatapi\chatapi\SendVCardRequest $send_v_card_request (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
