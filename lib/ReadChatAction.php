...
/**
 * ReadChatAction Class Doc Comment
 *
 * @category Class
 * @package  chatapi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ReadChatAction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReadChatAction';
     ...
     * Sets phone
     *
     * @param string|null $phone **Required if chatId is not set**  A phone number starting with the country code. You do not need to add your number.   USA example: 17472822486.
     *
     * @return $this
     */
