...
class Class6BanApi
{
     ...
     * Test ban settings
     *
     * @param  \chatapi\chatapi\BanTestAction $ban_test_action ban_test_action (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\BanTestStatus
     */
     ...
     * Test ban settings
     *
     * @param  \chatapi\chatapi\BanTestAction $ban_test_action (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\BanTestStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function banTestWithHttpInfo($ban_test_action)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\chatapi\chatapi\BanTestStatus' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\chatapi\chatapi\BanTestStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\chatapi\chatapi\BanTestStatus';
            $responseBody = $response->getBody();
     ...
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\BanSettings
     */
     ...
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\BanSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBanSettingsWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\chatapi\chatapi\BanSettings' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\chatapi\chatapi\BanSettings', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\chatapi\chatapi\BanSettings';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     * Set settings
     *
     * @param  \chatapi\chatapi\BanSettings $ban_settings ban_settings (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\BanSettings
     ...
     * Set settings
     *
     * @param  \chatapi\chatapi\BanSettings $ban_settings (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\BanSettings, HTTP status code, HTTP response headers (array of strings)
