...
class Class4WebhooksApi
{
     ...
     *
     * @param  \chatapi\chatapi\WebhookUrl $webhook_url webhook_url (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \chatapi\chatapi\SetWebhookStatus
     */
     ...
     * Sets the URL for receiving webhook
     *
     * @param  \chatapi\chatapi\WebhookUrl $webhook_url (required)
     *
     * @throws \chatapi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \chatapi\chatapi\SetWebhookStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function setWebhookWithHttpInfo($webhook_url)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\chatapi\chatapi\SetWebhookStatus' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\chatapi\chatapi\SetWebhookStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\chatapi\chatapi\SetWebhookStatus';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\chatapi\chatapi\SetWebhookStatus',
